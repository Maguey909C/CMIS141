// Import each required Java classimport java.io.IOException;
...
public class StandardIODemo
{
  public static void main(String[] args) throws IOException
  {
    ...
    //Prompt the user to enter a myBoolean
      System.out.println("Enter your next favorite boolean");
      //the nextBoolean() method scans the next boolean values
      otherBoolean = scannerIn.nextBoolean();
    ...
    // Print the results to verify your data
      ...
      System.out.println("Your favorite byte is: " + myByte);
      System.out.println("Your next favorite boolean is: " + otherBoolean);
  }
}
